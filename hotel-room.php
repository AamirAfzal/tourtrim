					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<?php //}else{ ?>
								<!-- <li><a href="forms/host/home">Host a Home</a></li>
								<li><a href="">Host an Experience</a></li> -->
								<?php //} ?>
								<!-- <li class="has-dropdown">
									<a href="#" style="color:aqua"><img src="images/user.png" alt="icon" hspace="15"><?php echo ucfirst($name) ?></a>
									<ul class="dropdown">
								...
								<!-- <li class="has-dropdown">
									<a href="#">Become a Host</a>
									<ul class="dropdown">
										<li><a href="forms/host/home">List your place</a></li>
										<li><a href="#">Host an experience</a></li>
									</ul>
								</li>
					...
					<div class="col-md-3">
						<div class="sidebar-wrap">
							<div class="side search-wrap animate-box">
				                ...
				                <div class="col-md-12">
				                  <input type="submit" name="home" id="submit" value="Find Hotel" class="btn btn-primary btn-block">
				                </div>
				              </div>
				            </form>
							</div>
