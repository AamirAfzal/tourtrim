...
<h1> Host a Tour </h1>
	...
	<div class="book-appointment">
		<div>
			<?php include("../../database/hosttour.php"); ?>
		</div>
		<!-- <h2> Host a Home </h2> -->
						<div class="book-form agileits-login">
							<form action="" method="post">
								...
								<div style="width: 100%;" class="phone_email phone_email1">
									<label>Price: </label>
									<div class="form-text">
								...
								<div class="agileits_reservation_grid">
									...
									<div class="span1_of_2">
										<label>Select Type of Adventure: </label>
										<!-- start_section_room -->
										<div class="section_room">
								...
								<div class="clear"></div>
								<input name="hosttour" type="submit" value="Host" style="width: 100%;">
							</form>
						</div>
